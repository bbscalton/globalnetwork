...
export const SUPPORTED_DEVICES: SupportedDevice[] = [
  ...
  },
  {
    ...
    brand: 'PIX-LINK',
    name: 'AC1200',
    sku: 'AC1200 (LV-AC22 / LV-AC11)',
    family: 'unsupported',
    role: 'home-router',
    recommended: false,
    canSuspend: false,
    streetCheap: 'Consumer junk · cheap dual-band AC1200 street router / repeater, no ISP API',
    manageVia: 'Local web UI / app only — no Omada SDN, RouterOS, UISP, or documented ISP REST API',
    notes:
      'Do not issue as managed CPE. No Omada/cloud/API path. Same class as TL-WR841N v14 and Mercusys MW301R v2 — Chinese OEM consumer Wi-Fi (router / repeater / AP modes). Box often stamped PIX-LINK; SKUs include LV-AC22 (AC1200 router) and LV-AC11/AC12 (AC1200 mini repeater). Disconnecting a house CPE is done on the Omada AP / ER7206, not WAN-off on this living-room box. Prefer hAP lite / ER605 / ER7206 + Omada AP for remote disconnect.',
    tags: [
      'pix-link',
      'pixlink',
      'pix link',
    ...
    caps: {
      suspend: { level: 'no', detail: 'No remote WAN/PPPoE API. Local UI only if you are on site' },
      passwords: { level: 'no', detail: 'Local web UI / app only' },
      reboot: { level: 'no', detail: 'Local only — no management channel for the desk' },
      lanConfig: { level: 'no', detail: 'Local only' },
      powerOff: { level: 'no', detail: 'No. Would need a smart plug in the house' },
    },
